...
import { ChevronDown, LogOut, Settings, Terminal, User } from 'lucide-react';
...
/**
 * Header content (#246): breadcrumb trail + right-aligned actions. Icon actions
 * use Tooltip; account + logout live in a DropdownMenu user menu. Rendered
 * inside the shell header (which provides the SidebarTrigger + height/border).
 */
        ...
        {isAdmin(user) && (
          <Tooltip>
            <TooltipTrigger asChild>
              <Button asChild variant="ghost" size="icon" title="Admin Settings" aria-label="Admin Settings">
                <Link to="/admin">
