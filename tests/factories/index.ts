...
export { createTestService, createTestServiceDeployment, resetServiceCounter } from './service.js';
...
export type { CreateTestServiceOptions, CreateTestServiceDeploymentOptions } from './service.js';
