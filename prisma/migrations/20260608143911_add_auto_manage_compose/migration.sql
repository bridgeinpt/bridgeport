...
CREATE TABLE "new_OperationsSettings" (
    ...
    "autoManageCompose" BOOLEAN NOT NULL DEFAULT false,
...
INSERT INTO "new_OperationsSettings" ("autoPruneImages", "defaultDockerMode", "defaultMetricsMode", "environmentId", "id", "pruneImagesMode") SELECT "autoPruneImages", "defaultDockerMode", "defaultMetricsMode", "environmentId", "id", "pruneImagesMode" FROM "OperationsSettings";
