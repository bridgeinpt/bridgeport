...
3. [Client-Side Data Fetching](#4-client-side-data-fetching) — **MEDIUM-HIGH**
   - 4.1 [Deduplicate Global Event Listeners](#41)
   - 4.2 [Use SWR for Automatic Deduplication](#42)
4. [Re-render Optimization](#5-re-render-optimization) — **MEDIUM**
   - 4.1 [Defer State Reads to Usage Point](#51)
   - 4.2 [Extract to Memoized Components](#52)
   - 4.3 [Narrow Effect Dependencies](#53)
   - 4.4 [Subscribe to Derived State](#54)
   - 4.5 [Use Lazy State Initialization](#55)
   - 4.6 [Use Transitions for Non-Urgent Updates](#56)
5. [Rendering Performance](#6-rendering-performance) — **MEDIUM**
   - 5.1 [Animate SVG Wrapper Instead of SVG Element](#61)
   - 5.2 [CSS content-visibility for Long Lists](#62)
   - 5.3 [Hoist Static JSX Elements](#63)
   - 5.4 [Optimize SVG Precision](#64)
   - 5.5 [Prevent Hydration Mismatch Without Flickering](#65)
   - 5.6 [Use Activity Component for Show/Hide](#66)
   - 5.7 [Use Explicit Conditional Rendering](#67)
6. [JavaScript Performance](#7-javascript-performance) — **LOW-MEDIUM**
   - 6.1 [Batch DOM CSS Changes](#71)
   - 6.2 [Build Index Maps for Repeated Lookups](#72)
   - 6.3 [Cache Property Access in Loops](#73)
   - 6.4 [Cache Repeated Function Calls](#74)
   - 6.5 [Cache Storage API Calls](#75)
   - 6.6 [Combine Multiple Array Iterations](#76)
   - 6.7 [Early Length Check for Array Comparisons](#77)
   - 6.8 [Early Return from Functions](#78)
   - 6.9 [Hoist RegExp Creation](#79)
   - 6.10 [Use Loop for Min/Max Instead of Sort](#710)
   - 6.11 [Use Set/Map for O(1) Lookups](#711)
   - 6.12 [Use toSorted() Instead of sort() for Immutability](#712)
7. [Advanced Patterns](#8-advanced-patterns) — **LOW**
   - 7.1 [Store Event Handlers in Refs](#81)
   - 7.2 [useLatest for Stable Callback Refs](#82)
...
### 3.2 Use SWR for Automatic Deduplication
